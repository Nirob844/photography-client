            ...
            <header className="p-4 bg-white shadow-2xl text-black">
                <div className="container flex justify-between h-16 mx-auto">
                    ...
                    <ul className="items-stretch hidden space-x-3 lg:flex">
                        ...
                        <li className="flex">
                            <NavLink to='/services' className="flex items-center px-4 -mb-1 border-b-2 border-transparent">Services</NavLink>
                        </li>

                        <li className="flex">
                            <NavLink to='/blog' className="flex items-center px-4 -mb-1 border-b-2 border-transparent">Blog</NavLink>
                        </li>
                        <li className="flex">
                            <NavLink to='/about' className="flex items-center px-4 -mb-1 border-b-2 border-transparent">About</NavLink>
                        </li>
                    </ul>
